  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> MOYUCF </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/piaoxue-181/site-status",
  home: "https://www.blowswind.cn",
  email: "mailto:admin@blowswind.cn",
};
</script>
